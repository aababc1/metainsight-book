...
The program used for assembly is called SPAdes [](doi:10.1089/cmb.2012.0021), which supports various types of data, and the command options vary depending on the input data.
